...
public class Search2DArray {
    public static void main(String args[]) {
        ...
        System.out.println(Arrays.toString(searchIndexArray(numarr, -23)));

    }

// As there are two indices involved the dtype of the return array will be an array itself 
// Note that here while we return the value we have to create and return an object using the 'new' keyword of type int
