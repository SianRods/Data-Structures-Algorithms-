public class BinarySearchTree {
    ...
    public void insert(int value) {
        ...
        //At the end of the Function call of the private insert function the root Node of the tree itself will
        // be returned ;
...
//        node.height = Math.max(node.left.getHeight(), node.right.getHeight()) + 1;
    ...
    // For a tree to be balanced both it's child heights should be balanced as well as it's left and right subtrees
    ...
    private static boolean balanced(Node node) {
        ...
        return Math.abs(node.left.getHeight() - node.right.getHeight()) <= 1 && balanced(node.left) && balanced(node.right);
    }
    ...
    //@Populating a Sorted Set of Values about their midpoint in order to obtain a fairly balanced
